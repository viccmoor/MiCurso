  ...
  return (
    <Modal visible={visible} animationType="fade" transparent>
      <Pressable
        ...
        onPress={onClose}
      >
        <View className="bg-[color:var(--color-background)] w-[90%] h-[28%] mb-[20px] rounded-2xl justify-center">
          <Text className="text-xl text-[color:var(--color-text-primary)] font-medium p-[15px]">
            ¿Qué deseas eliminar?
          </Text>
          ...
          >
            ...
            />
            <Text className="text-lg text-medium text-[color:var(--color-text-primary)]">
              Eliminar curso
            </Text>
          </Pressable>
          ...
          <Pressable className="w-full items-end" onPress={onClose}>
