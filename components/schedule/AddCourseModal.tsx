...
export default function AddCourseModal({
  ...
  const [data, setData] = useState<OptionSelectorData>(
    EMPTY_OPTION_SELECTOR_DATA,
  );
  ...
  const handleSearch = async () => {
    const hasValidInput = Object.entries(courseForm).some(
      ([key, value]) => key !== "period" && isValidParam(value),
    );
    ...
    try {
      ...
      if (data?.meta?.cursos_encontrados > 0) {
        ...
        setAlertInfo({
          ...
          description:
            "No se encontraron cursos que coincidan con los filtros ingresados.",
        });
        setAlertVisible(true);
      }
    } catch {
      setAlertInfo({
        ...
        description:
          "Ocurrió un problema al buscar los cursos. Intenta nuevamente en unos segundos.",
      });
      setAlertVisible(true);
    } finally {
      setLoading(false);
      ...
      >
        ...
        >
          <View className="flex-1 bg-[color:var(--color-background)]">
            <View className="absolute top-0 left-0 right-0 h-[80px] bg-[color:var(--color-background)] z-20 flex-row items-center justify-between px-4">
              <Pressable
                pointerEvents="auto"
                onPress={() => resetForm()}
                className="bg-[color:var(--color-background)] w-[40px] h-[40px] rounded-xs justify-center items-center"
              >
                <MaterialIcons
                  name="close"
                  size={20}
              ...
              >
                {loading ? (
                  ...
                  <View className="flex-row gap-2 items-center justify-center">
                    ...
                    />
                    <Text className="text-[color:var(--color-text-on-primary)] font-semibold text-base">
                      Buscar
                    </Text>
                  </View>
                )}
            ...
            >
              <View className="flex-row items-start border-t border-[color:var(--color-outline-secondary)] p-[10px] px-[20px]">
                <MaterialIcons
                ...
                <TextInput
                  ...
                  className="text-[color:var(--color-text-primary)] focus:text-[color:var(--color-text-primary)] placeholder:text-[color:var(--color-text-primary)] placeholder:font-normal text-xl rounded-lg p-[10px] w-full"
              ...
              <Pressable
                className="flex-row items-start gap-[10px] border-t border-[color:var(--color-outline-secondary)] p-[20px] active:bg-[#8885]"
                onPress={() => {
                  setData({
                    options: campusData,
                    name: "campus",
              ...
              >
                ...
                <Text className="text-[color:var(--color-text-primary)] text-xl">
                  {
                    campusData.find(
                      (opt) => opt.value === courseForm["campus"],
                    )!.label
                  }
                </Text>
              </Pressable>
              ...
              >
                ...
                <Text className="text-[color:var(--color-text-primary)] text-xl">
                  {
                    formatData.find(
                      (opt) => opt.value === courseForm["format"],
                    )!.label
                  }
                </Text>
              </Pressable>
              ...
              >
                ...
                <Text className="text-[color:var(--color-text-primary)] text-xl">
                  {
                    categoriesData.find(
                      (opt) => opt.value === courseForm["category"],
                    )!.label
                  }
                </Text>
              </Pressable>
              ...
              >
                ...
                <Text className="text-[color:var(--color-text-primary)] text-xl">
                  {
                    generalFormationData.find(
                      (opt) => opt.value === courseForm["generalFormationArea"],
                    )!.label
                  }
                </Text>
              </Pressable>
              ...
              >
                ...
                <Text className="text-[color:var(--color-text-primary)] text-xl">
                  {
                    academicUnitsData.find(
                      (opt) => opt.value === courseForm["academicUnit"],
                    )!.label
                  }
                </Text>
              </Pressable>
              ...
              >
                ...
                <Text className="text-[color:var(--color-text-primary)] text-xl">
                  {
                    admissionPeriodData.find(
                      (opt) => opt.value === courseForm["admissionPeriod"],
                    )!.label
                  }
                </Text>
              </Pressable>
              ...
              >
                ...
                <Text className="text-[color:var(--color-text-primary)] text-xl">
                  {
                    schoolData.find(
                      (opt) => opt.value === courseForm["school"],
                    )!.label
                  }
                </Text>
              </Pressable>
                ...
                <Text className="text-[color:var(--color-text-primary)] text-xl">
                  {
                    programLevelData.find(
                      (opt) => opt.value === courseForm["programLevel"],
                    )!.label
                  }
                </Text>
              </Pressable>
